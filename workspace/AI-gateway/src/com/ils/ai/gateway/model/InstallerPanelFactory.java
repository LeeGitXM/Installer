...
import com.ils.ai.gateway.panel.DatabasesStep;
...
import com.ils.ai.gateway.panel.ProjectsStep;
	...
	public BasicInstallerPanel createPanel(int panelIndex,BasicInstallerPanel prior,PanelType stepType,String title,Model<InstallerData> model) {
		...
		switch( stepType)  {
			...
			case DATABASE: step = new DatabaseStep(panelIndex,prior,title,model);
				break;
			case DATABASES: step = new DatabasesStep(panelIndex,prior,title,model);
				break;
			...
			case PROJECT: step = new ProjectStep(panelIndex,prior,title,model);
				break;
			case PROJECTS: step = new ProjectsStep(panelIndex,prior,title,model);
				break;
			case PROPERTY:
				break;
