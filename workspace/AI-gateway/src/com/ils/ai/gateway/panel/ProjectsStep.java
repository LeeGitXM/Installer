...
/**
 */
public class ProjectsStep extends BasicInstallerPanel {
	...
	public ProjectsStep(int index,BasicInstallerPanel previous,String title, Model<InstallerData> dataModel) {
