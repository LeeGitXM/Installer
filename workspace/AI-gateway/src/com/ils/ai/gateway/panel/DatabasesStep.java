 ...
 * 
 */
public class DatabasesStep extends BasicInstallerPanel {
	...
	public DatabasesStep(int index,BasicInstallerPanel previous,String title, Model<InstallerData> dataModel){
