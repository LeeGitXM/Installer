...
/**
 */
public class TagsStep extends BasicInstallerPanel {
	...
	public TagsStep(int index,BasicInstallerPanel previous,String title, Model<InstallerData> dataModel){
	...
	public void onInitialize() {
		super.onInitialize();
		handler = new AjaxRequestHandler(TagsStep.this.getPage());
