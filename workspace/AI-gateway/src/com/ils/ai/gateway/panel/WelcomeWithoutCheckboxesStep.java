 ...
 * 
 * This version of the welcome screen omits the two check boxes that left many confused.
 * The only thing that was mpmessential was the documentation which they can skip if they want to.
 * Also, I stopped updating the version information because it was impossible to determine what
 * actually changed from one vesion to the next and versioning was 100% manual and NOT tied to any
 * Source Code Control System.
 */
public class WelcomeWithoutCheckboxesStep extends BasicInstallerPanel {
	private static final long serialVersionUID = -3742149120641480873L;
	private static String fileName = "ReleaseNotes.pdf";

	
	public WelcomeWithoutCheckboxesStep(int index,BasicInstallerPanel previous,String title, Model<InstallerData> dataModel){
        ...
        /*
         *  The check boxes have been removed from the corresponding HTML template file so this code
         *  really doesn't do anything, except perhaps set the defaults.  In the spirit of not changing
         *  more than I had to, I left this code here even though it is superfluous.
         */
        
        /* Turn off the checkboxes */
        InstallerDataHandler dataHandler = InstallerDataHandler.getInstance();
        
        System.out.println("Setting SetIgnoringCurrent to FALSE...");
        data.setIgnoringCurrent(Boolean.FALSE);
        dataHandler.setPreference("currentCheckbox","false");
        
        System.out.println("Setting SetIgnorwOptional to FALSE...");
